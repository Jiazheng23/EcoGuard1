...
function IncidentReportDialog({ destination, user, onClose }) {
  ...
  return createPortal(<div className="fixed inset-0 z-[9999] grid place-items-center overflow-y-auto bg-slate-950/65 p-4 backdrop-blur-[2px]" role="dialog" aria-modal="true" aria-labelledby="incident-report-title" onMouseDown={(event) => { if (event.target === event.currentTarget && !saving) onClose() }}>
