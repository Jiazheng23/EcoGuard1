...
import { Building2, FileCheck2, LogOut, MapPin, Search, ShieldCheck } from 'lucide-react'
...
export default function LocationAdminApplicationPage() {
  ...
  return <main className="admin-theme min-h-screen bg-slate-50 p-4 sm:p-8">
    <section className="mx-auto max-w-3xl rounded-3xl border border-slate-100 bg-white p-6 shadow-sm sm:p-9">
      ...
      {loading ? <LoadingScreen compact label="Loading application..." /> : <form className="mt-8" onSubmit={submit}>
